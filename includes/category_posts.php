...
$get_posts = "select * from posts where category_id = '$category_id' LIMIT $page1, 5";
...
$page = mysql_query("select * from posts where category_id = '$category_id'");
...
$a=ceil($a);
	?><div class="row" style="margin-bottom: 50px;">
		...
		if($num - 1 > 0){
			?><a href="index.php?category=<?php echo $category_id; ?>&page=<?php echo $num - 1 ?>">
