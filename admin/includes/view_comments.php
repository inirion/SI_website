...
<div class="container">
	<table class="table table-hover table-bordered text-center">
		...
		<tbody>
			...
			?>
			<tr>
				<th class="text-center col-sm-1"><?php echo $comment_id;?></th>
				<th class="text-center col-sm-2"><?php echo $comment_author;?></th>
				<th class="text-center col-sm-5"><?php echo $comment_text;?></th>
				<th class="text-center col-sm-1"><?php echo $comment_date;?></th>
